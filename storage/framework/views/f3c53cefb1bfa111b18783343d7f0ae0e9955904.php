                                ...
                                <tbody wire:poll.keep-alive>
                                    <?php $__empty_1 = true; $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <th scope="col">
                                                <select class="form-control" wire:change="setChef(<?php echo e($order); ?>, $event.target.value)" required>
                                                    <option value="" disabled>Select Chef</option>
                                                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($user->id); ?>" <?php echo e($order->chef_id === $user->id ? "selected" : ""); ?>><?php echo e($user->name); ?></option>
...
</div><?php /**PATH C:\Users\masuk\SAROS\resources\views/livewire/admin/orders/list-orders.blade.php ENDPATH**/ ?>