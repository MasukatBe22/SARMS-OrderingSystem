...
} elseif ($_instance->childHasBeenRendered('FmFtlZW')) {
    $componentId = $_instance->getRenderedChildComponentId('FmFtlZW');
    $componentTag = $_instance->getRenderedChildComponentTagName('FmFtlZW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('FmFtlZW');
} else {
    $response = \Livewire\Livewire::mount('homepage.home-section', []);
    $html = $response->html();
    $_instance->logRenderedChild('FmFtlZW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php
...
} elseif ($_instance->childHasBeenRendered('oG4Lm2L')) {
    $componentId = $_instance->getRenderedChildComponentId('oG4Lm2L');
    $componentTag = $_instance->getRenderedChildComponentTagName('oG4Lm2L');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('oG4Lm2L');
} else {
    $response = \Livewire\Livewire::mount('homepage.menu-section', []);
    $html = $response->html();
    $_instance->logRenderedChild('oG4Lm2L', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        <?php
...
} elseif ($_instance->childHasBeenRendered('ZxN3LjV')) {
    $componentId = $_instance->getRenderedChildComponentId('ZxN3LjV');
    $componentTag = $_instance->getRenderedChildComponentTagName('ZxN3LjV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('ZxN3LjV');
} else {
    $response = \Livewire\Livewire::mount('homepage.team-section', []);
    $html = $response->html();
    $_instance->logRenderedChild('ZxN3LjV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
