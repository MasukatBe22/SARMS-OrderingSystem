    ...
    <div class="small-box bg-success">
      <div class="inner">
        <div class="d-flex justify-content-between">
            <h3 wire:loading.delay.remove><?php echo e($productCount); ?></h3>
...
<?php endif; ?>
      ...
      <a href="<?php echo e(route('admin.products')); ?>" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
    </div>
</div>
<?php /**PATH C:\Users\masuk\SAROS\resources\views/livewire/admin/dashboard/product-count.blade.php ENDPATH**/ ?>